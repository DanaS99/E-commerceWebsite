                  ...
                  <div className='flex items-center'>
                    ...
                    <div className='flex flex-row md:justify-start justify-end items-center mt-2'>
                      <button
                        ...
                        className='justify-center text-gray-700 size-6 flex items-center px-1.5 rounded-full bg-gray-200 hover:bg-primary hover:text-white ml-8'
                      >
                        -
                      </button>
                      ...
                      <button
                        ...
                        className='justify-center text-gray-700 size-6 flex items-center px-1.5 rounded-full bg-gray-200 hover:bg-primary hover:text-white'
                      >
                        +
                      </button>
                      <div className='ml-5'>
